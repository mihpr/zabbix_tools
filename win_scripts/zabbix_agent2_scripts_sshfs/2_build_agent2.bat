...
%WIN_ZABBIX_REPO_ROOT:~0,2%
cd "%WIN_ZABBIX_REPO_ROOT%\build\mingw"
dir

mingw32-make clean
:: With PCRE 1 and OPENSSL
mingw32-make PCRE=%WIN_PCRE_DIR% OPENSSL=%WIN_OPENSSL_DIR% RFLAGS="-DZABBIX_VERSION_RC_NUM=64"
REM mingw32-make ARCH=%ARCH% PCRE="C:\go-libs\pcre%CPU%" OPENSSL="C:\go-libs\openssl%CPU%" RFLAGS="-DZABBIX_VERSION_RC_NUM=%CPU%"
